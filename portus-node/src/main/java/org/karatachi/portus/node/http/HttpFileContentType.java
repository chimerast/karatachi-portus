...
public class HttpFileContentType {
    ...
    private static Map<String, String> contentTypeCellular;
    ...
    public static String getContentType(String filename) {
        ...
        if (dot > 0) {
            ...
            ret = contentTypeCellular.get(ext);
            if (ret != null) {
                return ret;
            }
        }
    ...
    static {
        ...
        // 携帯電話
        contentTypeCellular = new HashMap<String, String>();

        contentTypeCellular.put("hdml", "text/x-hdml");
        contentTypeCellular.put("wml", "text/vnd.wap.wml");
        contentTypeCellular.put("vcf", "x-vcard");
        contentTypeCellular.put("vcs", "x-vcalendar");
        contentTypeCellular.put("mmf", "application/x-smaf");
        contentTypeCellular.put("amc", "application/x-mpeg");
        contentTypeCellular.put("3g2", "video/3gpp2");
        contentTypeCellular.put("3gp", "video/3gpp");
        contentTypeCellular.put("jam", "application/x-jam");
        contentTypeCellular.put("kjx", "application/x-kjx");
        contentTypeCellular.put("dmt", "application/x-decomail-template");
        contentTypeCellular.put("khm", "application/x-kddi-htmlmail");
        contentTypeCellular.put("hmt", "application/x-htmlmail-template");
        contentTypeCellular.put("ucm", "application/x-ucf-package");
        contentTypeCellular.put("ucp", "application/x-ucf-package");
        contentTypeCellular.put("qcp", "audio/vnd.qcelp");
        contentTypeCellular.put("pmd", "application/x-pmd");
